    ...
    <div className="min-h-screen bg-[#030712] flex flex-col items-center relative overflow-hidden text-cyan-50">
      ...
      <footer className="w-full p-6 flex justify-between max-w-4xl z-20 gap-4">
        <button
          ...
          className="flex items-center gap-2 px-6 py-3 rounded-full font-bold transition-all duration-300 text-gray-500 hover:text-white hover:bg-white/5 disabled:opacity-50"
        >
          <ChevronLeft size={20} />
          <span>Back</span>
        </button>
